...
export default function WritingOptimizePage() {
  ...
  const handleOptimize = async () => {
    ...
    try {
      const res = await fetch('/api/generate/writing-optimize', {
        method: 'POST',
    ...
    <main className="min-h-screen bg-gray-50">
      <div className="bg-white border-b sticky top-0 z-10">
        <div className="max-w-6xl mx-auto px-4 py-4">
          <Link href="/writing" className="inline-flex items-center gap-2 text-gray-600 hover:text-amber-600 transition">
            <ArrowLeft size={20} />
            返回文书代写
          </Link>
        </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">文书优化</h1>
          <p className="text-gray-600">上传文书，超级AI帮你优化润色，提升表达力</p>
        ...
        <div className="bg-white rounded-xl shadow-md p-6 mb-6">
          ...
          <div className="mb-6">
            <label className="block text-sm font-medium text-gray-700 mb-2">
              上传文书文件 <span className="text-red-500">*</span>
            </label>
