    ...
    <main className="min-h-screen bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="text-center mb-12">
          <h1 className="text-3xl font-bold text-gray-900 mb-3">合同协议服务</h1>
          <p className="text-gray-600">选择你需要的服务</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          {/* 模板库 */}
          <Link href="/contract/templates" className="group">
            <div className="bg-white rounded-xl shadow-md p-6 text-center hover:shadow-lg transition border border-gray-100">
              ...
              <h2 className="text-xl font-semibold mb-2">模板库</h2>
              <p className="text-gray-500 text-sm mb-3">租赁、劳动、购销合同模板</p>
              <span className="text-emerald-600 font-medium">¥0.9起 →</span>
            </div>
          </Link>

          {/* 合同生成 */}
          <Link href="/contract/generate" className="group">
            <div className="bg-white rounded-xl shadow-md p-6 text-center hover:shadow-lg transition border border-gray-100">
              ...
              <h2 className="text-xl font-semibold mb-2">合同生成</h2>
              <p className="text-gray-500 text-sm mb-3">输入需求，生成定制合同</p>
              <span className="text-purple-600 font-medium">¥6.9/次 →</span>
            </div>
          </Link>

          {/* 合同优化 */}
          <Link href="/contract/optimize" className="group">
            <div className="bg-white rounded-xl shadow-md p-6 text-center hover:shadow-lg transition border border-gray-100">
              ...
              <h2 className="text-xl font-semibold mb-2">合同优化</h2>
              <p className="text-gray-500 text-sm mb-3">上传合同，超级AI优化条款</p>
